...
import type { SctpParameters, SctpNegotiatedCapabilities } from './sctpParametersTypes';
...
export type PipeTransportObserver = EnhancedEventEmitter<PipeTransportObserverEvents>;
export type PipeTransportObserverEvents = TransportObserverEvents & {
    sctpstatechange: [SctpState];
};
export interface PipeTransport<PipeTransportAppData extends AppData = AppData> extends Transport<PipeTransportAppData, PipeTransportEvents, PipeTransportObserver> {
    /**
     * Transport type.
     *
     * @override
...
export {};
//# sourceMappingURL=PipeTransportTypes.d.ts.map